...
class ArticlesS3 extends Component{
    render(){
        return( 
            <Container fluid className="articles-s3 bg-secondary d-flex minh-50vh align-items-center py-5">
